...
class NotificationClient:
    ...
    def send(self,recipient: str,message: str,channel: Channel = "sms",incident_id: Optional[str] = None) -> bool:
        ...
        body = {"recipient": recipient,"message": message,"channel": channel,"incident_id": incident_id,}
        try:
            ...
            logger.error("notification_FAILED channel=%s incident_id=%s error=%s",channel, incident_id, exc,)
            return False
